...
export class SnapDraw extends ethereum.SmartContract {
  static bind(address: Address): SnapDraw {
    return new SnapDraw("SnapDraw", address);
  }
  ...
  safeMint(to: Address, tokenURI: string): BigInt {
  ...
  try_safeMint(to: Address, tokenURI: string): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "safeMint",
